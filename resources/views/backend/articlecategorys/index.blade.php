...
@section('body.content')
	...
	<div class="container-fluid">
		{!! Breadcrumbs::render('backend.articlecategorys.index')!!}
			@include('backend.partials.messages')
			<div class="row">
				<div class="col-md-6 col-xs-6"><h3 class="margin-top-0">Table Category</h3></div>
				<div class="col-md-6 col-xs-6 text-right">
					<a class="btn btn-primary" href="{!!route('articlecategorys.create'); !!}"><i class="glyphicon glyphicon-plus-sign"></i> Create</a>
				</div>
			</div>
			<hr>
				...
				<div class="col-md-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
						    ...
						    ->setUrl(route('articlecategorys.data'))
